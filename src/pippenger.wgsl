...
@group(0) @binding(4)
var<storage, read_write> powerset_sums: array<JacobianPoint, 1048576>;
@group(0) @binding(5)
var<storage, read_write> cur_sum: array<JacobianPoint, 1048576>;
